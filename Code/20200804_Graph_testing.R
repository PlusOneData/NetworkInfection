...
covid_dt <- default_testing(testDelay = 3, testFrequency = 2)
...
set.seed(4321)
test0 <- createTimeline(rn, 60, covid_model)
test1 <- createTimeline(sfree, 60, covid_model)
...
animate_system(test0, 
               ...
               '20200805_Random_1000.gif')

animate_system(test1, 
               paste0("Scale Free Network of size ~", n), 
               '20200805_ScaleFree_1000.gif')

animate_system(test2, 
               paste0("Small World Network of size ~", n), 
               '20200805_SmallWorld_1000.gif')

# Save timeline as data files
readr::write_rds(test0, "./Data/20200805_Random_1000_1-15.rds")
readr::write_rds(test1, "./Data/20200805_ScaleFree_1000_1-15.rds")
readr::write_rds(test2, "./Data/20200805_SmallWorld_1000_1-15.rds")
...
ggsave('./Images/2000805_SIR_Distro_testing.pdf')
